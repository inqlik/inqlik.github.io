...
Other parts of InQlik Tools may be subject of another article. Lets look at Expression Editor.
...
You can [download][sd] and look at materials used in this article. Demo project is based on demo application `NorthWindExampleMart` from QlikView Deployment Framework. QDF file structure per se was not used in this tiny example, but essential function `LoadVariableCSV` was used.
